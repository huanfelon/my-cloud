package com.example.cloud.hystrixservice.service;
...
//    服务降级方法，当userService关闭的时候，调用当前的 getDefaultUser 方法
...
//    threadPoolKey：线程池名称，用于划分线程池
    ...
    public Future<User> getUserFuture(Long id) {
        return new AsyncResult<User>(){
            @Override
            public User invoke() {
                System.out.println("getUserFuture:{}"+ id);
    ...
    public List<User> getUserByIds(List<Long> ids) {
        System.out.println("getUserByIds:{}"+ ids);
